  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-4">
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
        ...
        >
          <GoogleIcon />
          {googleLoading ? '...' : 'Continuar con Google'}
        </button>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <Link href="/forgot-password" className="text-xs text-blue-600 font-semibold">¿Olvidaste tu contraseña?</Link>
            </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800" />}>
      <LoginForm />
    </Suspense>
  )
}
